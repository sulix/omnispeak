...
static void VL_SDL2VK_CreateShaders()
{
	...
	vertShaderCreateInfo.pCode = vert_spv;
	...
	fragShaderCreateInfo.pCode = frag_spv;
...
static void VL_SDL2VK_SyncBuffers(void *surface)
{
	(void)surface;
}

static void VL_SDL2VK_UpdateRect(void *surface, int x, int y, int w, int h)
{
	(void)surface;
	(void)x;
	(void)y;
