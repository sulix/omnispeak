...
int16_t SOUND_KEENWALK0;
int16_t SOUND_KEENWALK1;
int16_t SOUND_KEENJUMP;
int16_t SOUND_KEENLAND;
int16_t SOUND_KEENSHOOT;
int16_t SOUND_MINEEXPLODE;
int16_t SOUND_SLICEBUMP;
int16_t SOUND_KEENPOGO;
int16_t SOUND_GOTITEM;
int16_t SOUND_GOTSTUNNER;
int16_t SOUND_GOTVITALIN;
int16_t SOUND_UNKNOWN11;
int16_t SOUND_UNKNOWN12;
int16_t SOUND_LEVELEXIT;
int16_t SOUND_NEEDKEYCARD;
int16_t SOUND_KEENHITCEILING;
int16_t SOUND_SPINDREDFLYUP;
int16_t SOUND_GOTEXTRALIFE;
int16_t SOUND_OPENSECURITYDOOR;
int16_t SOUND_GOTGEM;
int16_t SOUND_KEENFALL;
int16_t SOUND_KEENOUTOFAMMO;
int16_t SOUND_UNKNOWN22;
int16_t SOUND_KEENDIE;
int16_t SOUND_UNKNOWN24;
int16_t SOUND_KEENSHOTHIT;
int16_t SOUND_UNKNOWN26;
int16_t SOUND_SPIROSLAM;
int16_t SOUND_SPINDREDSLAM;
int16_t SOUND_ENEMYSHOOT;
int16_t SOUND_ENEMYSHOTHIT;
int16_t SOUND_AMPTONWALK0;
int16_t SOUND_AMPTONWALK1;
int16_t SOUND_AMPTONSTUN;
int16_t SOUND_UNKNOWN34;
int16_t SOUND_UNKNOWN35;
int16_t SOUND_SHELLYEXPLODE;
int16_t SOUND_SPINDREDFLYDOWN;
int16_t SOUND_MASTERSHOT;
int16_t SOUND_MASTERTELE;
int16_t SOUND_POLEZAP;
int16_t SOUND_UNKNOWN41;
int16_t SOUND_SHOCKSUNDBARK;
int16_t SOUND_UNKNOWN43;
int16_t SOUND_UNKNOWN44;
int16_t SOUND_BARKSHOTDIE;
int16_t SOUND_UNKNOWN46;
int16_t SOUND_UNKNOWN47;
int16_t SOUND_UNKNOWN48;
int16_t SOUND_UNKNOWN49;
int16_t SOUND_UNKNOWN50;
int16_t SOUND_UNKNOWN51;
int16_t SOUND_UNKNOWN52;
int16_t SOUND_GALAXYEXPLODE;
int16_t SOUND_GALAXYEXPLODEPRE;
int16_t SOUND_GOTKEYCARD;
int16_t SOUND_UNKNOWN56;
int16_t SOUND_KEENLANDONFUSE;
int16_t SOUND_SPARKYPREPCHARGE;
int16_t SOUND_SPHEREFULCEILING;
int16_t SOUND_OPENGEMDOOR;
int16_t SOUND_SPIROFLY;
int16_t SOUND_UNKNOWN62;
int16_t SOUND_UNKNOWN63;
int16_t LASTSOUND;

int16_t CAMEIN_MUS;
int16_t LITTLEAMPTON_MUS;
int16_t THEICE_MUS;
int16_t SNOOPIN_MUS;
int16_t BAGPIPES_MUS;
int16_t WEDNESDAY_MUS;
int16_t ROCKNOSTONE_MUS;
int16_t OUTOFBREATH_MUS;
int16_t SHIKADIAIRE_MUS;
int16_t DIAMONDS_MUS;
int16_t TIGHTER_MUS;
int16_t ROBOREDROCK_MUS;
int16_t FANFARE_MUS;
int16_t BRINGEROFWAR_MUS;
int16_t LASTMUSTRACK;
